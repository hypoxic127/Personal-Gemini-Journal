        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="inline-flex items-center space-x-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-[#EAE5DD] text-[#5A5A40] border border-[#DCD3C6]">
                <Sparkles className="w-2.5 h-2.5 text-[#5A5A40] shrink-0" />
              ...
              {entryCount > 0 && (
                <span className="inline-flex items-center space-x-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-[#EFECE6] text-[#7D756D] border border-[#DCD3C6]">
                  <BookOpen className="w-2.5 h-2.5 text-[#7D756D] shrink-0" />
                  <span>
        ...
        {onViewChange && (
          <nav className="flex items-center space-x-1 bg-[#EFECE6] p-0.5 sm:p-1 rounded-xl border border-[#DCD3C6]">
            <button
              ...
              className={`px-2.5 sm:px-3 py-1 rounded-lg text-[11px] sm:text-xs font-semibold transition-all flex items-center space-x-1.5 cursor-pointer ${
                activeView === 'workspace'
